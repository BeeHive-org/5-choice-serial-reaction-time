...
class SerialBeeHive(Device): #This is the class that contains all the phases 
    ...
    def setup():
        ...
        button_food=machine.Pin(36,machine.Pin.IN) # Sensor LED for the food magazine
        button_dispenser = machine.Pin(33, machine.Pin.IN) # Sensor LEDs for the food dispenser to detect when food pellets come down
