...
#same as training stages 4-8 except SD is 1 sec and they have to perform 1000 trials.
#They do not need to fulfil a criterion to transit to the next stage

#Implemet the 5CSRTT code but only change SD to 1 
class stage_9_class(Device):
    @Device.setup
    def stage_setup():
        import machine
        import utime
    ...
    def stage9_task():
        ...
        for i in range(num_trials):
           ...
           # print('NP number chosen',choice)
            ...
            np_buttons = [button_1,button_2,button_3,button_4]                                    #list of wrong buttons that can be pressed during the game
            np_buttons_wrong = [] 
...
if __name__ == "__main__":
    ...
    bh = stage_9_class('COM9')  #Food training
    bh.stage_setup() # fm.food_setup
