...
class stage_10(Device):
    ...
    def stage10_setup():
        ...
        button_2 = machine.Pin(5,machine.Pin.IN)
    ...
    def stage10_task(num_trials=5):
        ...
        for trials in range(num_trials):
            ...
            #comlicated ugly code that allows for every ITI possiblity to be equal 
            possible_ITIs = [500,750,1250]
            index_current_ITI = 0
            ...
            for i in range(num_trials):
                ...
                selected_ITI = possible_ITIs[random.randint(0,len(possible_ITIs)-1)]
                if selected_ITI == 5:
                    count_trials_five += 1
            ...
            yield([trials, selected_ITI, "1", choice,premature_responce, correct_responses, omissions, incorrect_responce, mouse_to_food, task_end])
                
           # yield([trials, selected_ITI, "1", choice,premature_timer, correct_responses, omissions, task_duration, mouse_to_food, task_end])
...
if __name__ == "__main__":
    ...
    bh = stage_10('COM9')  #Food training
    bh.stage10_setup() # fm.food_setup

    bh.stage10_task() #this is for the spitting
    data = []
    #try:
    #print(bh.stage_5csrtt_task())
    for i in bh.stage10_task(1):
        print(i)
        data.append(i)
        print(data)
...
#things to look at for this:
    #sortig out premature responces if ther wasn't any and correct responses and omission and incorrect responses 
