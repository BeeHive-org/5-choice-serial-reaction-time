...
class stage_11(Device):
   ...
   def stage11_task():
       ...
       #trials starts with all lights being off
        NP_1.value(0)
        NP_2.value(0)
        NP_3.value(0)
        NP_4.value(0)
  ...
  #variables and trials:
        ...
        for trials in range(num_trials):
            ...
            yield([trials, ITI, SD, choice,premature_timer, correct_responses, omissions, task_duration, mouse_to_food, task_end])
...
if __name__ == "__main__":
    ...
    bh = stage_11('COM9')  #Food training
