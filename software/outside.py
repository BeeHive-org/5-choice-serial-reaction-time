...
for i in bh.food_training():
    ...
    try:
        with open(fileName,'w+') as csvfile: #within a new excel file
            ...
            csvwriter.writerow(["Trial","ITI","M2f","total"]) #writes the headers
...
#     #data4.append(i)
#     
#    # for i in range(0,len(data4),4):
#        # clean_data = []
#     try:
#         with open(fileName,'w+') as csvfile: #fid:
#             csvwriter = csv.writer(csvfile)
#             csvwriter.writerow(["trial","ITI","SD", "NP","premature_responses (ms)",  "correct_responses(ms)","m2f (ms)" , "incorrect responses (ms)", "wrong NP chosen",  "omissions","total (ms)"])
...
#     #data1.append(i)
#     
#    # for i in range(0,len(data5),4):
#        # clean_data = []
#     try:
#         with open(fileName,'w+') as csvfile: #fid:
#             csvwriter = csv.writer(csvfile)
#             csvwriter.writerow(["trial","ITI","SD", "Light","premature_responses (ms)",  "correct_responses(ms)","m2f (ms)" , "incorrect responses (ms)", "wrong NP chosen",  "omissions","total (ms)"])
